![Coin-Logo](https://i.imgur.com/E5oHb7o.png)
# HeldCoin Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a HeldCoin Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/N7BDRBS)
***
## Requirements
1) **1,500 HLDC coins.**
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Heldcoin/master/held_install.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash held_install.sh`
...
***Step 1***
* Download and install the HeldCoin wallet [here](http://heldcoin.xyz/)
***

***Step 2***
* Send EXACLY 1,500 HLDC to a receive address within your wallet.
***
